...
public final class HelpOverlay {
    ...
    public static void draw(View view) {
        DrawingUtils.drawInfoText(
                ...
                "",
                "Gadgets:",
                "    Clusters, Active cluster, Members count, New member type, Metric, Shading",
                "",
                "Controls:",
                "    h               - Toggle help",
                ...
                "    Mouse left      - Select/drag a handle; circle and line secondary handles appear after selection",
